...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_give_polrot_image(PyObject *self, PyObject *args)
{
  float * x0;
  double x1;
  double x2;
...
#else
#  define _cffi_f_give_polrot_image _cffi_d_give_polrot_image
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "give_polrot_image", (void *)_cffi_f_give_polrot_image, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_give_polrot_image },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__polrot_code(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__polrot_code(void) { return NULL; }
#  else
     init_polrot_code(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__polrot_code(void)
{
  return _cffi_init("_polrot_code", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_polrot_code(void)
{
  _cffi_init("_polrot_code", 0x2601, &_cffi_type_context);
}
#endif
