...
def test_fit_imaging_resonance_lorentzian():
    EXPECTED_AMP = 5.79
    EXPECTED_CENTER = 120.08
    EXPECTED_GAMMA = 2.77 
    EXPECTED_OFFSET = 10.54
    ...
    print(data_fitting_functions.fit_report(data_fitting_functions.imaging_lorentzian_function, *lorentzian_results))
